...
namespace UnityBuilderAction
{
    ...
    public static class BuildScript
    {
        ...
        private static string APP_NAME = "Gidles Tiles Hop";
        private static string COMPANY_NAME = "1695435264696566531209";
        private static string BUILD_VERSION_NAME = "1.0.0";
        private static string PACKAGENAME = "com.gidlekopgame.tileshop.musicgame";
        private static string PATH_KEYSTORE = "data.keystore";
        private static string KEYSTORE_PASS = "hangtuah";
        private static string KEY_ALIAS_NAME = "Tiles Hop";
        private static string KEY_ALIAS_PASS = "hangtuah";
